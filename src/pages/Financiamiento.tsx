  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Intro + enlaces útiles dentro de la tarjeta */}
          ...
          <div className="mx-auto max-w-6xl px-4">
            <Card className="border-2">
              ...
              <CardContent className="text-muted-foreground leading-relaxed">
                <p className="mb-3">
                  En esta sección encontrarás las alternativas de <strong>becas y beneficios</strong>,
                  junto con la información de <strong>aranceles y matrícula</strong> de la Universidad Técnica Federico Santa María.
                </p>

                <ul className="list-disc pl-5 space-y-1 mb-5">
                  <li>Revisa primero si cumples requisitos para <em>beneficios estatales</em> (Mineduc/DEMRE).</li>
                ...
                {/* Enlaces útiles como tarjetas pequeñas */}
                <div className="mt-6">
                  <Badge className="w-max mb-3" variant="secondary">Enlaces útiles</Badge>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <a
                      ...
                      className="h-14 group rounded-xl p-5 border-2 border-primary/20 bg-primary text-primary-foreground
                                 flex items-center justify-between hover:bg-primary/90 hover:shadow-usm-lg
                                 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary/30 p-5"
                    >
              ...
              <Card className="group border-2 hover:shadow-usm-lg transition-all duration-300 h-full flex flex-col">
                ...
                <CardContent className="flex flex-col justify-between flex-1">
                  <p className="text-muted-foreground mb-6">
                    Revisa <strong>becas estatales</strong> (Gratuidad, Bicentenario, Juan Gómez Millas, etc.),
                    <strong> becas internas USM</strong>, apoyos socioeconómicos y requisitos de postulación.
                  </p>
              ...
              <Card className="group border-2 hover:shadow-usm-lg transition-all duration-300 h-full flex flex-col">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-2xl">Aranceles y matrícula de pregrado</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="flex flex-col justify-between flex-1">
                  <p className="text-muted-foreground mb-6">
                    Consulta los <strong>aranceles</strong> por carrera y los valores de <strong>matrícula</strong>.
                    Incluye informaciones y más.
                  </p>
                  <div className="mt-auto flex flex-wrap gap-3">
                    <Link to="/financiamiento/aranceles" className="w-full sm:w-auto">
                      <Button className="rounded-xl w-full sm:w-auto">Ver aranceles y matrícula</Button>
                    </Link>
                  </div>
                </CardContent>
              </Card>
